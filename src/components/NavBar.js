        ...
        <header className="bg-gray-600">
            <div className="container mx-auto flex justify-between">
                <nav className="flex">
                    ...
                    <NavLink to="/trainings" className="inline-flex items-center py-3 px-3 my-6 rounded text-red-200 hover:text-yellow-800"
                    activeClassName="text-red-300 bg-gray-700">
                        Trajnimet
                    </NavLink>
                    <NavLink to="/conferences" className="inline-flex items-center py-3 px-3 my-6 rounded text-red-200 hover:text-yellow-800"
                    activeClassName="text-red-300 bg-gray-700">
                        Konferencat
                    </NavLink>
