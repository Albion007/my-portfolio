...
export default function About() {
    ...
    if (!author) return <div>Duke u ngarkuar...</div>;

    return (
        <main className="relative">
            <img src={wp} alt="wp background" className="absolute w-full" />
                ...
                <section className="bg-gray-500 rounded-lg shadow-2xl lg:flex p-20">
                    ...
                    <div className="text-lg flex flex-col justify-center">
                        <h1 className="cursive text-6xl text-green-300 mb-4">
                            Pershendetje. Unë jam{" "}
                            <span className="text-green-100">{author.name}</span>
                        </h1>
                        <div className="prose lg:prose-xl text-white">
                            <BlockContent blocks={author.bio} projectId="j9mt3zp2" dataset="production" />
                        </div>
                    </div>
                </section>
            </div>
